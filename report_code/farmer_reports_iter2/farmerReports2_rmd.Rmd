...
```{r, fig.height = 4.5, fig.width = 6.5, fig.align = 'center', warning = FALSE, echo = FALSE, message = FALSE}
...
```{r, fig.height = 4.5, fig.width = 5, fig.align = 'center', echo = FALSE, message = FALSE}
