---
title: "Child RMarkdown Template - Homeowner Reports"
---

<center>
__Biodiversity Report for report_name__ 
...
<br>
<br>
```{r setup, eval = FALSE, fig.align="left"}
...
```{r eval = FALSE, results = "asis", fig.align="left"}
...
<br>
<br>
```{r nat_herp_collage, out.width = "650px", eval = FALSE, warning = FALSE, fig.align = "center"}
...
<br>
<br>
```{r herp_nat_abun_plots, out.width = "800px", eval = FALSE, warning = FALSE, fig.align = "center"}
...
```{r herp_nat_message, out.width = "800px", eval = FALSE, warning = FALSE, fig.align = "left"}
...
<br>
<br>
```{r exo_herp_collage, out.width = "650px", eval = FALSE, warning = FALSE, fig.align = "center"}
...
<br>
<br>
```{r herp_exo_prop_plot, out.width = "850px", eval = FALSE, fig.align = "center"}
...
```{r herp_exo_sp_list, out.width = "600px", eval = FALSE, results = 'asis'}
j <- 1
...
<br>
<br>
```{r out.width = "850px", eval = FALSE, fig.align = "center",} 
...
```{r nat_birdsp_List_code, eval = FALSE, message = FALSE, results = FALSE}
...
<br>
<br>
```{r exo_birds_collage, out.width = "500px", eval = FALSE, warning = FALSE, fig.align = "center"}
...
```{r birdsExo_propPlot, out.width = "750px", eval = FALSE, fig.align = "center"}
print(birds_exo_prop_plot)
```
  


```{r birdExo_spList, out.width = "480px", eval = FALSE, fig.align = "left"}
l <- 1
...
<br>
<br>
```{r arths_collage, out.width = "500px", eval = FALSE, warning = FALSE, fig.align = "center"}
...
```{r arthSR, out.width = "850px", eval = FALSE, warning = FALSE, fig.align = "center"}
print(arthSR_plot)
```
<br>
...
<br>
<br>
```{r arthAB, out.width = "850px", eval = FALSE, warning = FALSE, fig.align = "center"}
print(arthAB_plot)
```
<br>
...
```{r arth_pieSite, fig.height = 5.5, out.width = "550px", eval = FALSE, warning = FALSE, fig.align = "center"}
print(arthSite_pie)

```
```{r arth_pieType, fig.height = 3.0,out.width = "700px", eval = FALSE, warning = FALSE, fig.align = "center"}
print(arthType_pie)
```
...
<br>
<br>
```{r ieco_logo, out.width = "250px", eval = FALSE, warning = FALSE, fig.align = "left"}
