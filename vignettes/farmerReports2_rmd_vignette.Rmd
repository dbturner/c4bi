---
title: "Child RMarkdown Template - Second Farmer Reports"
...
#### Based on our calculations of the urban landscape around your farm, your farm's Urban Intensity category is ***__r urbanInt_loop__***.
...
```{r, fig.height = 4.5, fig.width = 6.5, fig.align = 'center', warning = FALSE, eval = FALSE}
...
```{r, fig.height = 4.5, fig.width = 5, fig.align = 'center', eval= FALSE}
