...
### Load data files
``` {r, eval = FALSE}
herps_nat <- read.csv("data/Curacao native herps.csv")
herps_exo_prop <- read.csv("data/Curacao exotic herps summary stats.csv")
herps_exo_sp <- read.csv("data/Curacao exotic herps.csv")
birds_nat <- read.csv("data/Curacao native birds list.csv") 
birdsNat_sr <- read.csv("data/Curacao native birds.csv")
birds_exo <- read.csv("data/Curacao exotic birds summary stats.csv")
birdsExo_List <- read.csv("data/Curacao exotic birds.csv")
arth <- read.csv("data/Curacao arthropods.csv")
```
