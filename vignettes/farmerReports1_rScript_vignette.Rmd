...
1. Load data from farm biodiversity surveys
      a. Data needed (two .rda files): 
          i. abun.rich.sepa.rda
          ii. abun.div.pie.sepa.rda
...
for (i in 1:(nfarms-3)) { # We subtract by three because we don't want to create .html docs for the category means.
  ...
  render(here::here("analysis/farmerReports1_rmd.Rmd"), output_file = paste0(here::here('vignettes/farmerReport1_example_'), abun.rich.sepa$farmName[i], ".html"), "html_document") # This line actually executes each farm's .html report by calling the "child" .rmd file.
