...
<br>
<center>
![native_herps_pic](photos/Native Herps Collage.jpg)
</center>
<br>
...
if(is.na(herps_NA)){ # if we did not perform nocturnal surveys at a site, print out this message
  knitr::include_graphics("photos/herps_nat_message.png")
}
```
<br>
<br>
...
<br>
<center>
![exotic_herps_pic](photos/Exotic Herps Collage.jpg)
</center>
...
if(is.na(herps_exoList[[i]][1, 5])) {
  knitr::include_graphics("photos/herps_exo_message1.png") # if there were no nighttime surveys performed, thenprint this message saying there were no nighttime surveys performed
} else if (herps_exoList[[i]][1, 5] == 0) {
  knitr::include_graphics("photos/herps_exo_message2.png") # if we found no exotic herps, then print this message saying that none were found
} else {
...
<br>
<center>  
![birds_exo_collage](photos/Exotic Birds Collage.jpg){width=78%}
</center>
...
if (birdsExo_List[[i]][1, 5] == 0) {
  knitr::include_graphics("photos/birds_exo_message.png") # if we did not find any exotic birds at the site, then print a message that says none were observed
} else {
...
<br>
<center>
![arth_collage](photos/Arthropods Collage.jpg){width=70%}
</center>
...
```{r arth_pieSite, fig.height = 5.5, out.height = "300px", out.width = "550px", echo = FALSE, warning = FALSE, fig.align = "center", eval = TRUE}
print(arthSite_pie)
...
<br>
<br>
![ieco_logo](photos/iEco Logo.jpg){width=50%}
<br>
<br>
